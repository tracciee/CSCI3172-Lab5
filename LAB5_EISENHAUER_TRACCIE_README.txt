...
the search input area, as well as the ignredient name input area. For my API test, I am checking the functions of the server. I have one that ensures the Spoonacular API is sending a JSON object back to the server, 
...
To test the functionality of my website, I tested my application accross multiple browsers, ensuring functionality between google chrome and firefox. To further ensure the compatibility, I performed the same tests
